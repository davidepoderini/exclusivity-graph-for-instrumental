...
\end{multline}
\textcolor{blue}{
If the stable labelling represents all the possible deterministic strategies respecting the 
exclusivity relations between events, we can think of $\STAB(G)$ as defining all the possible 
probability assignments compatible with the exclusivity relations.
...
\begin{equation}
    ...
    \label{eq:alphastab}
\end{equation}
From which, we can see that $\alpha(G,w)$ must corresponds to the
